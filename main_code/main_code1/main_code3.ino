...
void setup(){
    ...
    LogFile.print("HELLO");
    LogFile.close();
    SensorData = SD.open("srdata.txt", FILE_WRITE);
    SensorData.print("test");
    SensorData.close();
...
void loop(){
    ...
    Serial.println(temp);
    Serial.println(alt);
    SensorData.println(pres);
    SensorData.println(temp);
    SensorData.println(alt);
    getL3GD20();
    Serial.println(gyrox);
    Serial.println(gyroy);
    Serial.println(gyroz);
    SensorData.println(gyrox);
    SensorData.println(gyroy);
